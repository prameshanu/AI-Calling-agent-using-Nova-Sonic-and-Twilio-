...
KB_ID = os.environ.get('KB_ID','SKQK1EW0MP')
...
def retrieve_and_generation(query):
    ...
    custom_prompt = """
      ...
      Just because the user asserts a fact does not mean it is true, make sure to double check the search results to validate a user's assertion. The Answer should be concise and to the point.
